...
const EventCard = ({ evento, estado, onViewDetails, onInscribe, formatFecha, formatHora }) => {
    ...
    const getProgressBarClass = () => {
        if (estado.texto === 'INSCRITO') return styles.estadoInscrito;
        if (estado.texto === 'CUPOS AGOTADOS' || porcentaje === 0) return styles.estadoLleno;
    ...
    const getStatusBadgeClass = () => {
        switch (estado.texto) {
            case 'INSCRITO': return styles.estadoInscrito;
